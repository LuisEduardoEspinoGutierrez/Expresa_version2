...
public class Ejercicio08 extends AppCompatActivity implements View.OnClickListener {
    ...
    private void cambiarImagen(String word) {
        switch (word.toUpperCase()) {
            ...
            case "CALAMAR":
                eje08_img1.setImageResource(R.drawable.eje08_img1_cc);
                break;
            case "CARACOL":
                eje08_img2.setImageResource(R.drawable.eje08_img2_cc);
                break;
            case "CARAMELO":
                eje08_img3.setImageResource(R.drawable.eje08_img3_cc);
                break;
            case "CARTA":
                eje08_img4.setImageResource(R.drawable.eje08_img4_cc);
                break;
            case "CORONA":
                eje08_img5.setImageResource(R.drawable.eje08_img5_cc);
                break;
            case "DINERO":
                eje08_img6.setImageResource(R.drawable.eje08_img6_cc);
                break;
            case "FAROLA":
                eje08_img7.setImageResource(R.drawable.eje08_img7_cc);
                break;
            case "HOGUERA":
                eje08_img8.setImageResource(R.drawable.eje08_img8_cc);
                break;
            case "HORMIGA":
                eje08_img9.setImageResource(R.drawable.eje08_img9_cc);
                break;
            case "TORTUGA":
                eje08_img10.setImageResource(R.drawable.eje08_img10_cc);
                break;
            case "TORO":
                eje08_img11.setImageResource(R.drawable.eje08_img11_cc);
                break;
            case "TESORO":
                eje08_img12.setImageResource(R.drawable.eje08_img12_cc);
                break;
            case "SIRENA":
                eje08_img13.setImageResource(R.drawable.eje08_img13_cc);
                break;
            case "RUEDA":
                eje08_img14.setImageResource(R.drawable.eje08_img14_cc);
                break;
            case "ROSA":
                eje08_img15.setImageResource(R.drawable.eje08_img15_cc);
                break;
            case "REMO":
                eje08_img16.setImageResource(R.drawable.eje08_img16_cc);
                break;
            case "RATÓN":
                eje08_img17.setImageResource(R.drawable.eje08_img17_cc);
                break;
            case "RAQUETA":
                eje08_img18.setImageResource(R.drawable.eje08_img18_cc);
                break;
            case "RANA":
                eje08_img19.setImageResource(R.drawable.eje08_img19_cc);
                break;
            case "RAMO":
                eje08_img20.setImageResource(R.drawable.eje08_img20_cc);
                break;
            case "PIRATA":
                eje08_img21.setImageResource(R.drawable.eje08_img21_cc);
                break;
            case "PERFUME":
                eje08_img22.setImageResource(R.drawable.eje08_img22_cc);
                break;
            case "PERCHA":
                eje08_img23.setImageResource(R.drawable.eje08_img23_cc);
                break;
            case "PERA":
                eje08_img24.setImageResource(R.drawable.eje08_img24_cc);
                break;
            case "PARAGUAS":
                eje08_img25.setImageResource(R.drawable.eje08_img25_cc);
                break;
            case "MARIPOSA":
                eje08_img26.setImageResource(R.drawable.eje08_img26_cc);
                break;
            case "MARIQUITA":
                eje08_img27.setImageResource(R.drawable.eje08_img27_cc);
                break;
            case "LORO":
                eje08_img28.setImageResource(R.drawable.eje08_img28_cc);
                break;
            case "PAPELERA":
                eje08_img29.setImageResource(R.drawable.eje08_img29_cc);
                break;
            case "PIRULETA":
                eje08_img30.setImageResource(R.drawable.eje08_img30_cc);
                break;
        }
    }
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.ivRegresarEje08) { finish(); }
        else if (v.getId() == R.id.btnAudioInstruccionesEje08) {
            if (mediaPlayerInstrucciones != null) {
        ...
        } else if (v.getId() == R.id.btnFinalizarEje08) {
            if (wordsFoundCount == 30) {
                guardarEjercicioCompletado();
            } else {
                int faltantes = 30 - wordsFoundCount;
        ...
        } else if (v.getId() == R.id.eje08_img1) {
            reproducirAudios(R.raw.audio_img1_eje8);
        } else if (v.getId() == R.id.eje08_img2) {
            reproducirAudios(R.raw.audio_img2_eje8);
        } else if (v.getId() == R.id.eje08_img3) {
            reproducirAudios(R.raw.audio_img3_eje8);
        } else if (v.getId() == R.id.eje08_img4) {
            reproducirAudios(R.raw.audio_img4_eje8);
        } else if (v.getId() == R.id.eje08_img5) {
            reproducirAudios(R.raw.audio_img5_eje8);
        } else if (v.getId() == R.id.eje08_img6) {
            reproducirAudios(R.raw.audio_img6_eje8);
        } else if (v.getId() == R.id.eje08_img7) {
            reproducirAudios(R.raw.audio_img7_eje8);
        } else if (v.getId() == R.id.eje08_img8) {
            reproducirAudios(R.raw.audio_img8_eje8);
        } else if (v.getId() == R.id.eje08_img9) {
            reproducirAudios(R.raw.audio_img9_eje8);
        } else if (v.getId() == R.id.eje08_img10) {
            reproducirAudios(R.raw.audio_img10_eje8);
        } else if (v.getId() == R.id.eje08_img11) {
            reproducirAudios(R.raw.audio_img11_eje8);
        } else if (v.getId() == R.id.eje08_img12) {
            reproducirAudios(R.raw.audio_img12_eje8);
        } else if (v.getId() == R.id.eje08_img13) {
            reproducirAudios(R.raw.audio_img13_eje8);
        } else if (v.getId() == R.id.eje08_img14) {
            reproducirAudios(R.raw.audio_img14_eje8);
        } else if (v.getId() == R.id.eje08_img15) {
            reproducirAudios(R.raw.audio_img15_eje8);
        } else if (v.getId() == R.id.eje08_img16) {
            reproducirAudios(R.raw.audio_img16_eje8);
        } else if (v.getId() == R.id.eje08_img17) {
            reproducirAudios(R.raw.audio_img17_eje8);
        } else if (v.getId() == R.id.eje08_img18) {
            reproducirAudios(R.raw.audio_img18_eje8);
        } else if (v.getId() == R.id.eje08_img19) {
            reproducirAudios(R.raw.audio_img19_eje8);
        } else if (v.getId() == R.id.eje08_img20) {
            reproducirAudios(R.raw.audio_img20_eje8);
        } else if (v.getId() == R.id.eje08_img21) {
            reproducirAudios(R.raw.audio_img21_eje8);
        } else if (v.getId() == R.id.eje08_img22) {
            reproducirAudios(R.raw.audio_img22_eje8);
        } else if (v.getId() == R.id.eje08_img23) {
            reproducirAudios(R.raw.audio_img23_eje8);
        } else if (v.getId() == R.id.eje08_img24) {
            reproducirAudios(R.raw.audio_img24_eje8);
        } else if (v.getId() == R.id.eje08_img25) {
            reproducirAudios(R.raw.audio_img25_eje8);
        } else if (v.getId() == R.id.eje08_img26) {
            reproducirAudios(R.raw.audio_img26_eje8);
        } else if (v.getId() == R.id.eje08_img27) {
            reproducirAudios(R.raw.audio_img27_eje8);
        } else if (v.getId() == R.id.eje08_img28) {
            reproducirAudios(R.raw.audio_img28_eje8);
        } else if (v.getId() == R.id.eje08_img29) {
            reproducirAudios(R.raw.audio_img29_eje8);
        } else if (v.getId() == R.id.eje08_img30) {
            reproducirAudios(R.raw.audio_img30_eje8);
        }
