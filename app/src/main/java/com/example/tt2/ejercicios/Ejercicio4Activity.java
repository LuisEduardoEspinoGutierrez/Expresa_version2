...
public class Ejercicio4Activity extends AppCompatActivity {
    ...
    private static final String TAG = "Ejercicio4Activity";
    ...
    private void mostrarToastConPuntos(String mensajeBase) {
        db.collection("usuarios").document(usuarioID).get()
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    Toast.makeText(Ejercicio4Activity.this, mensajeBase + puntos + " puntos en recompensas.", Toast.LENGTH_LONG).show();
                });
    }
