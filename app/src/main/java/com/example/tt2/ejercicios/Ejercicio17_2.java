...
public class Ejercicio17_2 extends AppCompatActivity {
    ...
    private static final String TAG = "Ejercicio17_2";
    ...
    private final String[] dynamicTexts = {"Erre","Erre", "Ahora di, perro", "Ahora di, tierra", "Ahora di, correr"};
    ...
    private final Runnable stopRecordingRunnable = new Runnable() {
        ...
        public void run() {
            if (recording != null) {
                stopRecording();
                Toast.makeText(Ejercicio17_2.this, "Límite de 30 segundos alcanzado", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void initializeViews() {
        ImageView ivRegresar = findViewById(R.id.ivRegresarEje17_2);
        ivPreview    = findViewById(R.id.ivVideoPreviewEje17_2);
        textureView  = findViewById(R.id.textureViewEjercicio17_2);
        videoContainer = findViewById(R.id.videoContainer17_2);
        cardVideoContainer = findViewById(R.id.cardVideoContainer17_2);
        scrollView = findViewById(R.id.scrollViewEje17_2);
        Button btnAudio = findViewById(R.id.btnAudioInstruccionesEje17_2);
        
        btnIntento = findViewById(R.id.btnGrabarVideoEje17_2);
        btnComenzar = findViewById(R.id.btnComenzarGrabacion17_2);
        btnDetener = findViewById(R.id.btnDetenerGrabacion17_2);
        btnSubir = findViewById(R.id.btnSubirVideo17_2);
        btnGrabarDeNuevo = findViewById(R.id.btnGrabarDeNuevo17_2);
        layoutPostGrabacion = findViewById(R.id.layoutPostGrabacion17_2);
        
        previewViewCamera = findViewById(R.id.previewViewCameraUser17_2);
        cardCameraOverlay = findViewById(R.id.cardUserCamera17_2);
        textureViewReproduccion = findViewById(R.id.textureViewUserPlayback17_2);
        tvStatus = findViewById(R.id.tvRecordingStatusUser17_2);
        tvDinamico = findViewById(R.id.tvDinamico17_2);
        
        Button btnPlay = findViewById(R.id.btnPlayVideoEje17_2);
        Button btnPause = findViewById(R.id.btnPauseVideoEje17_2);
        ImageView btnCambiar = findViewById(R.id.btnCambiarVideo17_2);
    ...
    private void switchVideo() {
        isErre2 = !isErre2;
        videoPath = "android.resource://" + getPackageName() + "/" + (isErre2 ? R.raw.erre_2 : R.raw.erre);
        ...
        Toast.makeText(this, "Cambiando a video " + (isErre2 ? "2" : "1"), Toast.LENGTH_SHORT).show();
    }
    ...
    private void setupVideoGuide() {
        videoPath = "android.resource://" + getPackageName() + "/" + R.raw.erre;
        if (ivPreview != null) {
            ivPreview.setVisibility(View.VISIBLE);
    ...
    private void captureVideo() {
        ...
        String name = "Ejercicio17_2_" + new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US).format(timeStamp);
    ...
    private void uploadVideo(Uri videoUri) {
        ...
        String userId = mAuth.getCurrentUser().getUid();
        long timestamp = System.currentTimeMillis();
        String fileName = userId + "_eje17.2_video_" + timestamp + ".mp4";
        StorageReference storageRef = storage.getReference().child("videos/ejercicio17.2/" + fileName);
        storageRef.putFile(videoUri)
                .addOnSuccessListener(taskSnapshot -> storageRef.getDownloadUrl()
                        .addOnSuccessListener(this::procesarFinalizacionConRecompensa))
                .addOnFailureListener(e -> {
                    btnSubir.setEnabled(true);
                    Toast.makeText(Ejercicio17_2.this, "Error al subir video: " + e.getMessage(), Toast.LENGTH_LONG).show();
                });
    }
    ...
    private void saveToFirestore(Uri downloadUri) {
        ...
        db.collection("progreso_ejercicios")
                .document(userId + "_17.2")
                .set(data, SetOptions.merge())
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(Ejercicio17_2.this, "¡Ejercicio guardado con éxito!", Toast.LENGTH_LONG).show();
                    showCompletedState();
                })
                .addOnFailureListener(e -> {
                    btnSubir.setEnabled(true);
                    Toast.makeText(Ejercicio17_2.this, "Error al guardar en BD: " + e.getMessage(), Toast.LENGTH_LONG).show();
                });
    }
    ...
    private void setInitialPreviewAndSize() {
        new Thread(() -> {
            ...
            try {
                int resId = isErre2 ? R.raw.erre_2 : R.raw.erre;
