...
public class Ejercicio06_3 extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String TAG = "Ejercicio06_3";
    private ImageView ivRegresarEje063;
    private TextView tvLecturaEje063;
    private Button btnAudioInstruccionesEje063, btnAudioTrabalenguasEje063, btnGrabarEje063, btnDetenerEje063, btnSubirEje063;
    private ImageButton btnPlayRecordedEje063;
    private CardView cvPlaybackEje063;
    private ProgressBar pbUploadEje063;
    ...
    private final String numeroEjercicio = "6.3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlayRecordedEje063 = findViewById(R.id.btnPlayRecordedEje063);
        cvPlaybackEje063 = findViewById(R.id.cvPlaybackEje063);
        pbUploadEje063 = findViewById(R.id.pbUploadEje063);
        ...
        btnPlayRecordedEje063.setOnClickListener(this);
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    if (documentSnapshot.exists()) {
                        ...
                        if (porcentaje != null && porcentaje >= 100) {
                            ...
                            btnGrabarEje063.setText("Completado");
                        }
                    }
                    isDataLoaded = true;
                })
    ...
    private void startRecording() {
        try {
            File file = new File(getExternalFilesDir(null), "audio_ejercicio6_3.mp4");
            ...
            recorder.setOnInfoListener((mr, what, extra) -> {
                if (what == MediaRecorder.MEDIA_RECORDER_INFO_MAX_DURATION_REACHED) {
                    stopRecording();
                    Toast.makeText(Ejercicio06_3.this, "Límite de 2 minutos alcanzado.", Toast.LENGTH_LONG).show();
                }
            });
            ...
            btnSubirEje063.setEnabled(false);
            cvPlaybackEje063.setVisibility(View.GONE);
    ...
    private void stopRecording() {
        try {
            if (recorder != null && isRecording) {
                ...
                btnGrabarEje063.setText("Reintentar");
                btnDetenerEje063.setEnabled(false);
                btnSubirEje063.setEnabled(true);
                cvPlaybackEje063.setVisibility(View.VISIBLE);
    ...
    private void playRecordedAudio() {
        ...
        try {
            ...
            btnPlayRecordedEje063.setImageResource(android.R.drawable.ic_media_pause);
            mediaPlayerRecorded.setOnCompletionListener(mp -> btnPlayRecordedEje063.setImageResource(android.R.drawable.ic_media_play));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void uploadAudio() {
        ...
        String fileName = usuarioID + "_eje6_3_audio_" + timestamp + ".mp4";
        StorageReference ref = storageRef.child("audios/ejercicio6.3/" + fileName);
        pbUploadEje063.setVisibility(View.VISIBLE);
        pbUploadEje063.setProgress(0);
        btnSubirEje063.setEnabled(false);
        btnGrabarEje063.setEnabled(false);
        ref.putFile(file)
                .addOnProgressListener(snapshot -> {
                    double progress = (100.0 * snapshot.getBytesTransferred()) / snapshot.getTotalByteCount();
                    pbUploadEje063.setProgress((int) progress);
                })
                .addOnSuccessListener(taskSnapshot -> {
                    isUploaded = true;
                    pbUploadEje063.setVisibility(View.GONE);
                    btnGrabarEje063.setText("Completado");
    ...
    private void mostrarToastConPuntos(String mensajeBase) {
        db.collection("usuarios").document(usuarioID).get()
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    Toast.makeText(Ejercicio06_3.this, mensajeBase + puntos + " puntos en recompensas.", Toast.LENGTH_LONG).show();
                });
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.ivRegresarEje063) {
            if (isRecording) stopRecording();
            finish();
        }
        else if (id == R.id.btnAudioTrabalenguasEje063) reproducirAudios(R.raw.trabalenguas_eje6_3);
        else if (id == R.id.btnAudioInstruccionesEje063) {
            if (mediaPlayerInstrucciones != null) {
                if (mediaPlayerInstrucciones.isPlaying()) mediaPlayerInstrucciones.seekTo(0);
                else mediaPlayerInstrucciones.start();
            }
        }
        else if (id == R.id.btnGrabarEje063) {
            if (isUploaded) {
        ...
        else if (id == R.id.btnDetenerEje063) stopRecording();
        else if (id == R.id.btnSubirEje063) uploadAudio();
        else if (id == R.id.btnPlayRecordedEje063) playRecordedAudio();
    }
}
