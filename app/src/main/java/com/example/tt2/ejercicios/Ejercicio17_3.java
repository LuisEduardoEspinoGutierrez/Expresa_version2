...
public class Ejercicio17_3 extends AppCompatActivity {
    ...
    private static final String TAG = "Ejercicio17_3";
    ...
    private final String[] dynamicTexts = {"irri", "irri", "Ahora di Mirri"};
    ...
    private final Runnable stopRecordingRunnable = new Runnable() {
        ...
        public void run() {
            if (recording != null) {
                stopRecording();
                Toast.makeText(Ejercicio17_3.this, "Límite de 30 segundos alcanzado", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void initializeViews() {
        ImageView ivRegresar = findViewById(R.id.ivRegresarEje17_3);
        ivPreview    = findViewById(R.id.ivVideoPreviewEje17_3);
        textureView  = findViewById(R.id.textureViewEjercicio17_3);
        videoContainer = findViewById(R.id.videoContainer17_3);
        cardVideoContainer = findViewById(R.id.cardVideoContainer17_3);
        scrollView = findViewById(R.id.scrollViewEje17_3);
        Button btnAudio = findViewById(R.id.btnAudioInstruccionesEje17_3);
        
        btnIntento = findViewById(R.id.btnGrabarVideoEje17_3);
        btnComenzar = findViewById(R.id.btnComenzarGrabacion17_3);
        btnDetener = findViewById(R.id.btnDetenerGrabacion17_3);
        btnSubir = findViewById(R.id.btnSubirVideo17_3);
        btnGrabarDeNuevo = findViewById(R.id.btnGrabarDeNuevo17_3);
        layoutPostGrabacion = findViewById(R.id.layoutPostGrabacion17_3);
        
        previewViewCamera = findViewById(R.id.previewViewCameraUser17_3);
        cardCameraOverlay = findViewById(R.id.cardUserCamera17_3);
        textureViewReproduccion = findViewById(R.id.textureViewUserPlayback17_3);
        tvStatus = findViewById(R.id.tvRecordingStatusUser17_3);
        tvDinamico = findViewById(R.id.tvDinamico17_3);
        
        Button btnPlay = findViewById(R.id.btnPlayVideoEje17_3);
        Button btnPause = findViewById(R.id.btnPauseVideoEje17_3);
        ImageView btnCambiar = findViewById(R.id.btnCambiarVideo17_3);
    ...
    private void switchVideo() {
        isIrri2 = !isIrri2;
        videoPath = "android.resource://" + getPackageName() + "/" + (isIrri2 ? R.raw.irri_2 : R.raw.irri);
        ...
        Toast.makeText(this, "Cambiando a video " + (isIrri2 ? "2" : "1"), Toast.LENGTH_SHORT).show();
    }
    ...
    private void setupVideoGuide() {
        videoPath = "android.resource://" + getPackageName() + "/" + R.raw.irri;
        if (ivPreview != null) {
            ivPreview.setVisibility(View.VISIBLE);
    ...
    private void captureVideo() {
        ...
        String name = "Ejercicio17_3_" + new SimpleDateFormat("yyyyMMdd_HHmmss", Locale.US).format(timeStamp);
    ...
    private void uploadVideo(Uri videoUri) {
        ...
        String userId = mAuth.getCurrentUser().getUid();
        long timestamp = System.currentTimeMillis();
        String fileName = userId + "_eje17.3_video_" + timestamp + ".mp4";
        StorageReference storageRef = storage.getReference().child("videos/ejercicio17.3/" + fileName);
        storageRef.putFile(videoUri)
                .addOnSuccessListener(taskSnapshot -> storageRef.getDownloadUrl()
                        .addOnSuccessListener(this::procesarFinalizacionConRecompensa))
                .addOnFailureListener(e -> {
                    btnSubir.setEnabled(true);
                    Toast.makeText(Ejercicio17_3.this, "Error al subir video: " + e.getMessage(), Toast.LENGTH_LONG).show();
                });
    }
    ...
    private void saveToFirestore(Uri downloadUri) {
        ...
        db.collection("progreso_ejercicios")
                .document(userId + "_17.3")
                .set(data, SetOptions.merge())
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(Ejercicio17_3.this, "¡Ejercicio guardado con éxito!", Toast.LENGTH_LONG).show();
                    showCompletedState();
                })
                .addOnFailureListener(e -> {
                    btnSubir.setEnabled(true);
                    Toast.makeText(Ejercicio17_3.this, "Error al guardar en BD: " + e.getMessage(), Toast.LENGTH_LONG).show();
                });
    }
    ...
    private void setInitialPreviewAndSize() {
        new Thread(() -> {
            ...
            try {
                int resId = isIrri2 ? R.raw.irri_2 : R.raw.irri;
